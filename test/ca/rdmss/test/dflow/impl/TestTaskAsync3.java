...
public class TestTaskAsync3 extends TaskAsync<TestContext3> {
	...
	public TestTaskAsync3(String taskId) {
		this(taskId, true);
	}

	public TestTaskAsync3(String taskId, boolean isNotException) {
		this(taskId, isNotException, null);
	}

	public TestTaskAsync3(String taskId, TaskTransition transition) {
		this(taskId, transition, null);
	}

	public TestTaskAsync3(String taskId, TaskTransition transition, AtomicInteger fail) {
		this.taskId = taskId;
	...
	public TestTaskAsync3(String taskId, boolean isNotException, AtomicInteger fail) {
		this.taskId = taskId;
