...
public class TestTask2 extends TaskSync<TestContext2> {
	...
	public TestTask2(String taskId) {
		this(taskId, true);
	}

	public TestTask2(String taskId, boolean isNotException) {
		this(taskId, isNotException, null);
	}

	public TestTask2(String taskId, TaskTransition transition) {
		this(taskId, transition, null);
	}

	public TestTask2(String taskId, TaskTransition transition, AtomicInteger fail) {
		this.taskId = taskId;
	...
	public TestTask2(String taskId, boolean isNotException, AtomicInteger fail) {
		this.taskId = taskId;
